...
namespace BulletPro
{
	...
	public class ShotParams : EmissionParams
	{
		...
		public bool hasUnknownBulletAmount; // holds true when simultaneousBulletsPerFrame has invalid of unknown dynamic value (ie. equal to another parameter)
		...
		public int fakeBulletAmount; // used for previewing bullets if hasUnknownBulletAmount is true
