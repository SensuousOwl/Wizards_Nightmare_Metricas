...
namespace BulletPro.EditorScripts
{
    ...
    [CustomPropertyDrawer(typeof(DynamicObjectReference))]
    public class DynamicObjectReferenceDrawer : DynamicParameterDrawer
    {
        ...
        public override void DrawFixed(SerializedProperty property, SerializedProperty nonDynamicValue, GUIContent label)
        {
            if (property.FindPropertyRelative("narrowType").boolValue)
            {
                System.Type specificType = System.Type.GetType(property.FindPropertyRelative("typeName").stringValue);
                ...
                if (property.FindPropertyRelative("requireComponent").boolValue)
                {
