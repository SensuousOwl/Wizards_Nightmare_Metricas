...
namespace BulletPro.EditorScripts
{
    ...
    [CustomPropertyDrawer(typeof(DynamicAnimationCurveValue))]
    public class DynamicAnimationCurveValueDrawer : DynamicValueDrawer
    {
        ...
        {
            if (!dynamicParameter.FindPropertyRelative("forceZeroToOne").boolValue) base.DrawFixed(property, nonDynamicValue, label);
            else
            {
