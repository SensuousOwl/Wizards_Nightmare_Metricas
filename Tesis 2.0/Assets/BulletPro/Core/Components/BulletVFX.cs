...
namespace BulletPro
{
	...
	public class BulletVFX : MonoBehaviour
	{
		...
		public void ResetOwnership()
		{
			...
			// Restore old parent, but not scale (which is done by VFXManager upon recruiting the object)
			if (thisTransform.parent != BulletVFXManager.instance.self)
				thisTransform.SetParent(BulletVFXManager.instance.self);
		}
