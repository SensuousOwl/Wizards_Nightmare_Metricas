...
namespace _Main.Scripts.PlayerScripts
{
    ...
    public class StatsController
    {
        ...
        public StatsController(PlayerData p_playerData)
        {
            ...
            m_statsDictionary.Add(StatsId.CriticalDamageMult, p_playerData.CriticalDamageMult);
            m_statsDictionary.Add(StatsId.SpawnItemChance, p_playerData.SpawnItemChance);
            m_statsDictionary.Add(StatsId.FireRate, p_playerData.FireRate);
            m_statsDictionary.Add(StatsId.Range, p_playerData.FireRange);
