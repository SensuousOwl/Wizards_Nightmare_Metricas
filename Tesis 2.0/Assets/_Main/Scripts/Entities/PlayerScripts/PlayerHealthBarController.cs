...
namespace _Main.Scripts.Entities.PlayerScripts
{
    public class PlayerHealthBarController : MonoBehaviour
    {
        ...
        private IEnumerator Initialize()
        {
            ...
            m_previuosMaxHp = StatsService.GetBaseStatById(StatsId.MaxHealth);
            
            StatsService.OnChangeStatValue += OnChangeMaxHealth;
            m_healthController.OnChangeHealth += UpdateHpBar;
            
            OnChangeMaxHealth(StatsId.MaxHealth, m_healthController.GetMaxHealth());
        ...
        {
            var l_hpPercentage = (p_currHp / p_maxHp);
            healthBarFillObj.value = l_hpPercentage;
